...
public class Finish extends javax.swing.JInternalFrame
{
    ...
    public Finish(JDesktopPane desktop, int orderNum, double price, int quantity)
    {
        initComponents();
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        if (!date.equals(""))
        {
            try
            {
                ...
                {
                    JOptionPane.showMessageDialog(Finish.this, "Delivery Date needs to be after " + minDate);
                }
            }
